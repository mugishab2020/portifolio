...
import myImage from '../public/images/car1.jpg'; // Update the path to your image
      ...
      <div className="container px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className='ml-10'>
            ...
            <h3 className="text-3xl font-bold mb-6 italic bold">PERSONAL INFORMATION</h3>
            <ul>
              <li className="mb-2 fade-in" style={{ animationDelay: '0.1s' }}><strong>Name:</strong> Edson Mugisha</li>             
              <li className="mb-2 fade-in" style={{ animationDelay: '0.2s' }}><strong>Age:</strong> 22 Years</li>
            ...
            <button className="text-white bg-green-900 mt-8 py-2 px-4 rounded-full font-bold hover:bg-white hover:text-black fade-in" style={{ animationDelay: '1s'}}>
              Download my CV
            </button>
          </div>
          ...
          <div className="flex items-center justify-center">
            <img src={myImage} alt="About Me" className="w-34 h-34  mt-34 rounded-full object-cover border-4 border-green-500 fade-in" style={{ animationDelay: '1.3s'}} />
          </div>
        </div>
      </div>
    </section>
